...
namespace Inventory
{
    public partial class SearchDataBase : Form
    {
        ...
        private void SearchDataBase_Load(object sender, EventArgs e)
        {
            ...
            this.mainStockBindingSource.ResetBindings(true);
            this.mainStockTableAdapter.Adapter.Update(this.modelID);
            this.mainStockTableAdapter.GetDataMainStockMaterialInfo();
